...
{
    const char* pszTimestamp = "zimbcoin";
    const CScript genesisOutputScript = CScript() << ParseHex("090084710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
         ...
         */
        pchMessageStart[0] = 0xf4; //0xf6 , 0xf0, 0xf8
        ...
        genesis = CreateGenesisBlock(1638659992, 2000238922, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc8c4b759f8057e1077676341a9f9864fc26ae267fb536a9b5b2c55ac64816376"));
        assert(genesis.hashMerkleRoot == uint256S("0x0460004248aa036c92fd103dcf16fa1f0b5927f889382ef53feeb9f57f6ec391"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xc8c4b759f8057e1077676341a9f9864fc26ae267fb536a9b5b2c55ac64816376"))
        ...
        chainTxData = ChainTxData{
            ...
            1638659992, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1638659992, 1175320, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3f2f122ec04211dade3086135cdda2fb9df3e1cf7c145a7e8044b161b4a3522c"));
        assert(genesis.hashMerkleRoot == uint256S("0x0460004248aa036c92fd103dcf16fa1f0b5927f889382ef53feeb9f57f6ec391"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x3f2f122ec04211dade3086135cdda2fb9df3e1cf7c145a7e8044b161b4a3522c")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1638659992, 1, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4a5220cc6d9a63b5e3ef165fc308183f86ff7b4598b44a9507170559b91f54d2"));
        assert(genesis.hashMerkleRoot == uint256S("0x0460004248aa036c92fd103dcf16fa1f0b5927f889382ef53feeb9f57f6ec391"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x4a5220cc6d9a63b5e3ef165fc308183f86ff7b4598b44a9507170559b91f54d2"))
        };
