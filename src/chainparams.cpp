...
{
    const char* pszTimestamp = "this is worthy coin";
    const CScript genesisOutputScript = CScript() << ParseHex("099984710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
         ...
         */
        pchMessageStart[0] = 0xf8; //0xf6 , 0xf0
        ...
        genesis = CreateGenesisBlock(1638542064, 2000318263, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5d3d6979191f0d955b902af589110dc3cba0e79743dad218435de94bb124de65"));
        assert(genesis.hashMerkleRoot == uint256S("0x4fbbcf5f6722290fb25414ec0b1ce378cff45698b825f7194601537aa671a7f4"));
        ...
        // vSeeds.push_back(CDNSSeedData("zimbcointools.com", "dnsseed.zimbcointools.com"));
        // vSeeds.push_back(CDNSSeedData("zimbcoinpool.org", "dnsseed.zimbcoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x5d3d6979191f0d955b902af589110dc3cba0e79743dad218435de94bb124de65"))
        ...
        chainTxData = ChainTxData{
            ...
            1638542064, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1638542064, 161979, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xceb7dc976e34ea6e875e47e9bf266994d603a67d0e7f416ec1bf5a35b65986f5"));
        assert(genesis.hashMerkleRoot == uint256S("0x4fbbcf5f6722290fb25414ec0b1ce378cff45698b825f7194601537aa671a7f4"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("150.95.113.87", "150.95.113.87")); //150.95.113.87
        // vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b  -testnet.thrasher.io", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xceb7dc976e34ea6e875e47e9bf266994d603a67d0e7f416ec1bf5a35b65986f5")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1638542064, 4, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb2961ebb6fa0f628d8f39b4740754ec3fa37ad6d65c579314a0a0519500f375a"));
        assert(genesis.hashMerkleRoot == uint256S("0x4fbbcf5f6722290fb25414ec0b1ce378cff45698b825f7194601537aa671a7f4"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xb2961ebb6fa0f628d8f39b4740754ec3fa37ad6d65c579314a0a0519500f375a"))
        };
